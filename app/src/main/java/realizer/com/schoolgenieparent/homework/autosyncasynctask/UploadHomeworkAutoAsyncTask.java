 ...
 */
public class UploadHomeworkAutoAsyncTask extends AsyncTask<Void, Void,StringBuilder> {
    ...
    public UploadHomeworkAutoAsyncTask(TeacherHomeworkModel o, Context myContext, OnTaskCompleted cb, String flag) {
    ...
    protected void onPostExecute(StringBuilder stringBuilder) {
        ...
        stringBuilder.append("@@@"+ Integer.valueOf(obj.getHid())+"@@@Homework");
