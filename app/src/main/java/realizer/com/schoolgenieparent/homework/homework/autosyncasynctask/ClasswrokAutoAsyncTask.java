 ...
 */
public class ClasswrokAutoAsyncTask extends AsyncTask<Void, Void,StringBuilder>
{
    ...
    public ClasswrokAutoAsyncTask(ParentHomeworkListModel o, Context myContext, OnTaskCompleted cb) {
