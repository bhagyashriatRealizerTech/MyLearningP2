 ...
 */
public class HomewrokAutoAsyncTask extends AsyncTask<Void, Void,StringBuilder>
{
    ...
    public HomewrokAutoAsyncTask(ParentHomeworkListModel o, Context myContext, OnTaskCompleted cb) {
